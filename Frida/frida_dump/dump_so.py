...
if __name__ == "__main__":
    # device: frida.core.Device = frida.get_usb_device() # PC
    device = frida.get_device_manager().add_remote_device("127.0.0.1:16384") # Android
    print("已连接到设备: " + device.name)
    pid = device.get_frontmost_application().pid # 获取前台应用的 PID, 需要手动打开应用
